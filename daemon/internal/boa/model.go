...
type Station struct {
	...
	RetriesKnown bool `json:"retries_known,omitempty"`
	...
	TxPhyMode string `json:"tx_phy_mode,omitempty"`
	RxPhyMode string `json:"rx_phy_mode,omitempty"`
...
type Client struct {
	...
	RetryPct float64 `json:"retry_pct,omitempty"`
